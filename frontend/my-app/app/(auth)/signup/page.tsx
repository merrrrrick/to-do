...
const Signup = () => {
  ...
  return (
    <div className="w-full h-screen flex items-center justify-center text-black">
      <form className="flex w-[60%] sm:w-[50%] md:w-[45%] lg:w-[40%] xl-[25%] flex-col justify-center gap-4 p-4 bg-white/90 border border-white shadow-2xl rounded-lg sm:p-6 md:p-8  ">
        ...
        <label htmlFor="email" className="block mt-2 text-sm font-medium text-gray-900">Email:</label>
         <div className="relative">
          <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
            <svg
        ...
        <label htmlFor="password" className="block mt-2 text-sm font-medium text-gray-900">Password:</label>
         <div className="relative">
          <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
